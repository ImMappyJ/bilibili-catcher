<html>
    <head>
        <meta charset="utf-8" />
        <title>BiliInfo</title>
        <link rel="stylesheet" type="text/css" href="css/header.css"></link>
        <link rel="stylesheet" type="text/css" href="css/searcher.css"></link>
    ...
    <body>
        <ul class="header-menu">
            ...
            <li class="header-menu-item" style="float:right"><a href="https://github.com/ImMappyJ/bilibili-catcher" target="_blank">Github</a></li>
        </ul>
    </body>
</html>